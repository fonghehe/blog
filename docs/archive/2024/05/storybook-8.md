---
title: "Storybook 8 正式发布改进"
date: 2024-05-24 14:31:23
tags:
  - Storybook
readingTime: 2
description: "关于Storybook 8 正式发布改进，很多开发者只停留在 API 调用层面。本文试图从生产环境的角度，讨论实际中会遇到的问题和解决方案。"
wordCount: 297
---

关于Storybook 8 正式发布改进，很多开发者只停留在 API 调用层面。本文试图从生产环境的角度，讨论实际中会遇到的问题和解决方案。
