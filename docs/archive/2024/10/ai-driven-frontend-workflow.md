---
title: "AI 驱动的前端工作流：我的实践总结"
date: 2024-10-18 10:00:00
tags:
  - 工程化
readingTime: 2
description: "2024 年，AI 工具已经从\"可选\"变成\"必要\"了。整理一下我目前的 AI 辅助开发工作流。"
wordCount: 603
---

2024 年，AI 工具已经从"可选"变成"必要"了。整理一下我目前的 AI 辅助开发工作流。
...
把错误栈和相关代码给 AI，通常能快速定位方向。但 AI 有时会给出自信但错误的答案，要保持怀疑。

## AI 的局限：必须自己处理的

**业务逻辑**：AI 不了解你的产品需求，决策要自己做。

**安全性**：AI 生成的代码可能有安全漏洞（SQL 注入、XSS、IDOR），必须自己审查。
...
**性能调优**：AI 能给出理论建议，但真正的性能问题要用 Profiler 分析。

**架构决策**：选哪个方案、如何组织代码，AI 的建议是参考，不是答案。
