---
title: "CSS Preprocessor Selection Guide"
date: 2021-05-31 10:22:58
tags:
  - CSS

readingTime: 1
description: "CSS 预处理器选择指南在近年来发展迅速，本文将深入分析其原理和实践方法。"
wordCount: 182
---

CSS 预处理器选择指南在近年来发展迅速，本文将深入分析其原理和实践方法。
...
- 性能优化需要基于实际数据，避免过度优化
- CSS 预处理器选择指南的核心在于理解底层原理，而非仅仅记住 API
