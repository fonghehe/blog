---
title: "Angular 16 Required Inputs and Input Transforms: Type-Safe Component Interfaces"
...
## Required Inputs: Mandatory Inputs
...
## Input Transforms: Automatic Input Value Transformation
...
## Relationship with Signal Inputs
