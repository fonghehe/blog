---
title: "shadcn/ui: Rethinking Component Library Design"
...
Traditional component libraries (Element UI, Ant Design): you install them, use them, but can't modify them (only override via API).

shadcn/ui: puts the component code in your project, **you own that code** and can modify it freely.
...
- **Radix UI**: Unstyled, accessibility-first component primitives
- **Tailwind CSS**: Styling
- **class-variance-authority (CVA)**: Managing variants
