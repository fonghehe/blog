---
title: "Angular 18.1: Signal Inputs/Outputs/Queries Fully Stable"
date: 2024-08-02 10:56:33
tags:
  - Angular
  - Performance Optimization
readingTime: 2
description: "Angular 18.1 于 2024 年 7 月 10 日发布，最重要的变化是将此前处于开发者预览阶段的 **Signal-based Inputs、Outputs 和 Queries 全部提升为稳定 API**。这意味着从 18.1 起，可以在生产环境中放心使用这套全新的组件 API，无需担心 breaking c"
wordCount: 259
---
...
## Officially Stable Signal API List
...
## Complete Signal Component Example
...
## Migration Guide: From Decorators to Signal API
...
## Signal API Performance Advantages
