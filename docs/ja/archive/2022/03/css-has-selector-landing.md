---
title: "CSS :has() セレクターが正式に登場"
date: 2022-03-23 14:31:25
tags:
  - CSS
readingTime: 2
description: "最近チームでCSS :has() 选择器正式落地，において多くの経験を積みました。参考のためにまとめましたので、同様の作業をされる方のお役に立てれば幸いです。"
wordCount: 514
---

最近チームでCSS :has() 选择器正式落地，において多くの経験を積みました。参考のためにまとめましたので、同様の作業をされる方のお役に立てれば幸いです。
