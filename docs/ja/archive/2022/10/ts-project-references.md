---
title: "TypeScript プロジェクト参照"
date: 2022-10-28 10:22:28
tags:
  - TypeScript
readingTime: 2
description: "在日常开发中，TypeScript 项目引用の使用頻度が高まっています。本記事では、その使い方、原理、最適化戦略を体系的に説明します。"
---

在日常开发中，TypeScript 项目引用の使用頻度が高まっています。本記事では、その使い方、原理、最適化戦略を体系的に説明します。
