---
title: "フロントエンド Monorepo の実践"
date: 2022-11-02 14:50:29
tags:
  - フロントエンドエンジニアリング
readingTime: 3
description: "关于前端 Monorepo 实践，：多くの開発者はAPIの呼び出しレベルにとどまっています。本記事では本番環境の観点から、実際に遭遇する問題と解決策を議論します。"
---

关于前端 Monorepo 实践，：多くの開発者はAPIの呼び出しレベルにとどまっています。本記事では本番環境の観点から、実際に遭遇する問題と解決策を議論します。
