---
title: "CSS @scope：スコープされたスタイル"
date: 2023-03-22 09:48:52
tags:
  - CSS
readingTime: 2
description: "最近在团队中落地CSS @scope 作用域样式，して多くの経験を積みました。参考のためにまとめましたので、同様の作業をされる方のお役に立てれば幸いです。"
wordCount: 503
---

最近在团队中落地CSS @scope 作用域样式，して多くの経験を積みました。参考のためにまとめましたので、同様の作業をされる方のお役に立てれば幸いです。
