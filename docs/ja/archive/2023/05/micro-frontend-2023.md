---
title: "マイクロフロントエンド 2023：アーキテクチャ進化まとめ"
date: 2023-05-25 10:22:47
tags:
  - マイクロフロントエンド
readingTime: 2
description: "关于微前端 2023 架构演进总结，：多くの開発者はAPIの呼び出しレベルにとどまっています。本記事では本番環境の観点から、実際に遭遇する問題と解決策を議論します。"
wordCount: 443
---

关于微前端 2023 架构演进总结，：多くの開発者はAPIの呼び出しレベルにとどまっています。本記事では本番環境の観点から、実際に遭遇する問題と解決策を議論します。
