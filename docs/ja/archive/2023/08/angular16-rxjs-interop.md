---
title: "Angular 16 RxJS Interop：toSignal と toObservable の実践"
...
## toSignal：Observable を Signal としてラップ
...
## toObservable：Signal を Observable に変換
...
`toSignal` 内部已处理自动キャンセル订阅，但对于手动订阅的场景，Angular 16 提供了 `takeUntilDestroyed`：
