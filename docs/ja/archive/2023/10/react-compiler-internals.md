---
title: "React コンパイラの内部原理"
date: 2023-10-30 10:56:30
tags:
  - React
readingTime: 2
description: "关于React 编译器原理，：多くの開発者はAPIの呼び出しレベルにとどまっています。本記事では本番環境の観点から、実際に遭遇する問題と解決策を議論します。"
wordCount: 433
---

关于React 编译器原理，：多くの開発者はAPIの呼び出しレベルにとどまっています。本記事では本番環境の観点から、実際に遭遇する問題と解決策を議論します。
