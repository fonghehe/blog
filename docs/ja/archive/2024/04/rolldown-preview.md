---
title: "Rolldown 安定版：Rust ビルド"
date: 2024-04-10 10:39:55
tags:
  - フロントエンド
readingTime: 2
description: "关于Rolldown 稳定版 Rust 构建，API 呼び出しのレベルで止まっている開発者が多いです。本記事では、プロダクション環境の観点から実際に遭遇する問題と解決策を説明します。"
wordCount: 462
---

关于Rolldown 稳定版 Rust 构建，API 呼び出しのレベルで止まっている開発者が多いです。本記事では、プロダクション環境の観点から実際に遭遇する問題と解決策を説明します。
