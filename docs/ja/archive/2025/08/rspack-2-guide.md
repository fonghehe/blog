---
title: "Rspack 2.0 完全ガイド：Module Federation 2.0 与持久缓存"
date: 2025-08-08 10:42:19
tags:
  - フロントエンド
readingTime: 2
description: "最近チームでRspack 2.0 完全ガイドを導入し、多くの経験を積みました。参考のためにまとめましたので、同様の作業をされる方のお役に立てれば幸いです。"
wordCount: 425
---

最近チームでRspack 2.0 完全ガイドを導入し、多くの経験を積みました。参考のためにまとめましたので、同様の作業をされる方のお役に立てれば幸いです。
