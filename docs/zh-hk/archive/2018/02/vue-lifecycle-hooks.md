...
tags:
  - Vue
readingTime: 1
description: "Vue 的生命週期是面試必考題，也是真正理解 Vue 組件運行機制的關鍵。今天結合實際項目場景，把每個鈎子的使用時機説清楚。"
wordCount: 212
---

Vue 的生命週期是面試必考題，也是真正理解 Vue 組件運行機制的關鍵。今天結合實際項目場景，把每個鈎子的使用時機説清楚。
