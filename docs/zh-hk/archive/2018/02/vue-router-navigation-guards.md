---
title: "Vue Router 導航守衞全解析"
date: 2018-02-01 16:46:07
tags:
  - Vue
readingTime: 3
description: "Vue Router 的導航守衞是項目裏權限控制的核心，但文檔寫得比較分散，容易搞混。這篇文章把所有守衞梳理一遍，附上實際項目中的用法。"
wordCount: 575
---

Vue Router 的導航守衞是項目裏權限控制的核心，但文檔寫得比較分散，容易搞混。這篇文章把所有守衞梳理一遍，附上實際項目中的用法。
...
這種模式把權限聲明放在路由配置，守衞只負責統一檢查，維護起來比較清晰。
