...
const d2 = new Dog();
d1.friends.push("貓咪");
console.log(d2.friends); // ['貓咪'] ← d2 也被污染了！
```
...
function Dog(name, breed) {
  Animal.call(this, name); // 在子類構造函數里調用父類
  this.breed = breed;
}
...
現在寫新代碼都用 ES6 class，理解原型鏈繼承是為了讀懂老代碼和麪試。