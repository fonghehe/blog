---
title: "前端部署：nginx 設定與緩存策略"
date: 2018-06-12 17:34:52
tags:
  - 工程化
readingTime: 2
description: "寫了很多前端代碼，但部署環節經常依賴運維同學。這次自己動手配了一個 nginx，把常見場景整理一下。"
wordCount: 222
---
...
```nginx
# Webpack 開啓 compression-webpack-plugin 生成 .gz 檔案
location ~* \.(js|css)$ {
