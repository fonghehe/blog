---
title: "Webpack splitChunks 代碼分割實戰"
date: 2018-06-09 16:08:30
tags:
  - Webpack
  - 工程化
readingTime: 2
description: "Webpack 4 用 `splitChunks` 替代了之前的 `CommonsChunkPlugin`，配置更簡單。記錄一下實際項目裏的配置。"
wordCount: 269
---
...
不分割的情況下，所有代碼打成一個 `main.js`，用户每次訪問都需要加載整個文件，即使大部分頁面他用不到。
