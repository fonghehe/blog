...
tags:
  - 性能優化
readingTime: 1
description: "寫了一個複雜的動畫，發現很卡。研究了一下重繪和迴流的原理，整理優化方法。"
---

寫了一個複雜的動畫，發現很卡。研究了一下重繪和迴流的原理，整理優化方法。
...
el.style.fontSize = "16px"; // 字體大小影響佈局
...
- 批量 DOM 操作，避免讀寫交叉觸發強制同步佈局
- 動畫用 `transform` 替代 `top/left`，觸發 GPU 合成
- `will-change: transform` 提前創建合成層
