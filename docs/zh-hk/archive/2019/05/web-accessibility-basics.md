---
title: "前端開發者應該知道的 Web 無障礙（a11y）基礎：落地路徑與實戰建議"
date: 2019-05-26 10:51:45
tags:
  - 前端
readingTime: 6
description: "無障礙（accessibility，縮寫 a11y）在國內前端開發中經常被忽視，但它並不隻是\"給盲人用的\"。鍵盤用户、色覺障礙用户、臨時性損傷用户（比如手臂骨折隻能單手操作）都是無障礙的受益者。作為前端開發者，掌握基礎的 a11y 知識是專業素養的一部分。"
wordCount: 944
---

無障礙（accessibility，縮寫 a11y）在國內前端開發中經常被忽視，但它並不隻是"給盲人用的"。鍵盤用户、色覺障礙用户、臨時性損傷用户（比如手臂骨折隻能單手操作）都是無障礙的受益者。作為前端開發者，掌握基礎的 a11y 知識是專業素養的一部分。
...
彈窗打開時，焦點應該限製在彈窗內，不能 Tab 到彈窗背後的內容。
