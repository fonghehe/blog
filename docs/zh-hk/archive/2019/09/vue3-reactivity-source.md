---
title: "Vue 3 Alpha 源碼閲讀：響應式系統原理"
date: 2019-09-24 15:06:04
tags:
  - Vue
readingTime: 2
description: "Vue 3 alpha 代碼公開了！第一時間去看了響應式系統（packages/reactivity），相比 Vue 2 改變很大。"
wordCount: 217
---

Vue 3 alpha 代碼公開了！第一時間去看了響應式系統（packages/reactivity），相比 Vue 2 改變很大。
...
| 
-------- | -------------------------- | ---------------------- |
| 初始化   | 遞歸遍歷所有屬性           | 懶代理（訪問到才代理） |
| 新增屬性 | 不追蹤（需要 $set）        | 自動追蹤               |
| 數組     | 重寫 7 個方法              | 原生支持               |
| 內存     | 每個屬性創建 getter/setter | WeakMap 管理依賴       |
