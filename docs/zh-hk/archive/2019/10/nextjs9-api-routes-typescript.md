...
tags:
  - TypeScript
readingTime: 2
description: "Next.js 9 在 9 月底發佈，帶來了兩個重要特性：內置 TypeScript 支援和更完善的 API Routes。"
wordCount: 176
---
...
```bash
# 不再需要手動設定，直接創建 tsconfig.json
touch tsconfig.json
npm run dev  # Next.js 自動填充 tsconfig.json

# 或者直接創建 .tsx 檔案，Next.js 會提示安裝必要的包
```
...
- Next.js 9 內置 TypeScript，零設定開箱即用
