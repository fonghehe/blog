---
title: "Vue 組件懶加載策略：落地路徑與實戰建議"
date: 2020-02-03 15:25:31
tags:
  - Vue
readingTime: 3
description: "首屏加載效能是前端優化的核心指標之一。Vue 項目的路由級懶加載已經很常見，但組件級懶加載、圖片懶加載、數據懶加載這些更細粒度的策略同樣值得深入掌握。本文從工程實踐出發，整理一套完整的懶加載方案。"
wordCount: 376
---

首屏加載效能是前端優化的核心指標之一。Vue 項目的路由級懶加載已經很常見，但組件級懶加載、圖片懶加載、數據懶加載這些更細粒度的策略同樣值得深入掌握。本文從工程實踐出發，整理一套完整的懶加載方案。
...
列表數據量大時（超過 1000 條），即使隻渲染可見區域的 DOM 也能大幅提升效能。
