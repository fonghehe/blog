...
tags:
  - 前端
readingTime: 2
description: "pnpm 8 發佈了，作為我們團隊的默認包管理器，升級後做了全面的效能對比測試。"
wordCount: 352
---

pnpm 8 發佈了，作為我們團隊的默認包管理器，升級後做了全面的效能對比測試。
...
`workspace:*` 始終使用本地版本，`workspace:^` 發佈時會轉成 `^x.y.z`。這是 pnpm 原生支援的，不需要額外設定。
