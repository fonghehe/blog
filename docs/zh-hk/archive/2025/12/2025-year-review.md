---
title: "2025 年前端技術回顧：Signal 時代正式開啓"
date: 2025-12-31 11:45:22
tags:
  - 前端
readingTime: 2
description: "2025 年是前端技術\"從實驗到成熟\"的一年。React 20 Compiler 穩定、Angular 21 完成 Signal 化轉型、Vue Vapor Mode 落地、Rolldown 穩定進入生產、AI 編程工具從輔助變成協同開發的核心。站在 2025 年最後一天，來做一個全面的年度盤點。"
wordCount: 281
---

2025 年是前端技術"從實驗到成熟"的一年。React 20 Compiler 穩定、Angular 21 完成 Signal 化轉型、Vue Vapor Mode 落地、Rolldown 穩定進入生產、AI 編程工具從輔助變成協同開發的核心。站在 2025 年最後一天，來做一個全面的年度盤點。
...
Svelte   → Svelte 5 Runes（2024 發佈，2025 全面普及）
...
// ② Server Actions（成熟）：表單和數據變更的一等公民
...
工具              狀態變化                    主要貢獻
──────────────────────────────────────────────────────────
Rolldown          2025 年中穩定，Vite 7 集成  Rust 重寫 Rollup，構建快 10x+
oxc               oxlint 規則集完善至 80%+    替代 ESLint 的成熟方案
Vite 7            Rolldown 作為生產後端        構建速度革命
Turbopack         Next.js 16 生產默認          Next.js 生態獨佔
Farm              小眾但性能極佳               Rust 構建工具競爭者
```
...
① 多文件 Agent 編寫（Cursor、Windsurf、Claude Code）
  → 從"單文件補全"到"功能模塊生成"
  → 前端重複性工作（CRUD 頁面、表單組件）生產率提升 3-5x
...
2025 年前端的核心敍事是：**Signal 作為響應式原語統一了各大框架的設計語言**，構建工具完成了 Rust 化轉型，AI 編程工具達到了真正可用於日常工作的成熟度。對於前端開發者，2025 年的核心收穫是：熟悉了 Signal 模型（無論是 Angular/Vue/Svelte）、用上了 Compiler 級別的優化（React Compiler/Svelte 5）、並真正將 AI 工具融入了日常工作流。2026 年見。
