---
title: "AI 代碼審查 2026 最佳實踐：實踐方法與治理思路"
...
4. 記憶體泄漏：檢查未清理的 subscription、timer、observer
...
AI 審查不是替人做決策，而是幫人做資訊篩選。在 CI 中集成時，關鍵是讓 AI 做初篩，把需要人工關注的點高亮出來。
...
最大的陷阱是"AI 説沒問題就真的沒問題"。AI 會遺漏業務邏輯錯誤、上下文依賴的問題、以及團隊約定俗成的隱含規則。我的做法是：AI 負責機械性檢查（類型安全、效能模式、常見 bug pattern），人負責業務正確性和架構一致性。
