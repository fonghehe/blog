...
tags:
  - Vue
readingTime: 3
description: "Vue Router 的導航守衛是專案裡許可權控製的核心，但檔案寫得比較分散，容易搞混。這篇文章把所有守衛梳理一遍，附上實際專案中的用法。"
wordCount: 590
---

Vue Router 的導航守衛是專案裡許可權控製的核心，但檔案寫得比較分散，容易搞混。這篇文章把所有守衛梳理一遍，附上實際專案中的用法。
...
這種模式把許可權宣告放在路由設定，守衛隻負責統一檢查，維護起來比較清晰。
