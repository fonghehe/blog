...
tags:
  - 前端
readingTime: 2
description: "Axios 是目前最主流的 HTTP 客戶端，但很多專案隻是簡單呼叫，沒有做統一封裝，導致請求邏輯散落各處。這篇文章整理一下完整的封裝方案。"
wordCount: 289
---

Axios 是目前最主流的 HTTP 客戶端，但很多專案隻是簡單呼叫，沒有做統一封裝，導致請求邏輯散落各處。這篇文章整理一下完整的封裝方案。
