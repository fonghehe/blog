...
tags:
  - 工程化
readingTime: 2
description: "團隊協作裡 Git 工作流是個容易被忽視的基礎設施，但亂了之後非常痛苦。整理一套適合前端團隊的規範。"
---

團隊協作裡 Git 工作流是個容易被忽視的基礎設施，但亂了之後非常痛苦。整理一套適合前端團隊的規範。
...
- `MAJOR`：不相容的 API 變化（1.0.0 → 2.0.0）
- `MINOR`：向後相容的新功能（1.0.0 → 1.1.0）
...
# 暫存當前工作
git stash save "WIP: 使用者頁面修改"
git stash pop  # 恢復

# 合併某個 commit 到當前分支
git cherry-pick abc1234

# 互動式 rebase（整理 commit 歷史）
git rebase -i HEAD~3
```
