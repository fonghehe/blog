...
tags:
  - Vue
readingTime: 1
description: "slot 是 Vue 元件複用裡最強大的機製之一，但很多人隻用到了最基礎的預設 slot。整理一下實際專案中的用法。"
wordCount: 209
---

slot 是 Vue 元件複用裡最強大的機製之一，但很多人隻用到了最基礎的預設 slot。整理一下實際專案中的用法。
...
普通 slot 隻能用父元件的資料。作用域 slot 可以把子元件的資料傳給父元件，讓父元件決定如何渲染。
