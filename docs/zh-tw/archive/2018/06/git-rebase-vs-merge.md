...
tags:
  - 工程化
readingTime: 2
description: "團隊裡經常討論用 rebase 還是 merge，各有支援者。理清一下兩者的區別和適用場景。"
wordCount: 345
---
...
merge 會建立一個新的 merge commit，保留了分支發生時的完整歷史。
...
- 公共分支隻用 merge，本地 feature 分支可以 rebase
- 推送前用互動式 rebase 整理零碎 commit
- 團隊統一一套規範比哪種方式更重要
