---
title: "Angular Material 入門：構建企業級 UI 元件庫"
date: 2018-09-01 17:34:02
tags:
  - Angular
readingTime: 2
description: "Angular Material 是 Angular 官方出品的 Material Design UI 元件庫，開箱即用、可訪問性良好，適合快速構建企業管理系統。"
wordCount: 171
---
...
# 選擇一個預置主題，或自定義
# 是否新增 BrowserAnimationsModule？Yes
# 是否新增全域性字型和圖示？Yes
```
...
Angular Material 遵循模組化原則，用什麼引什麼：
...
Angular Material 覆蓋了企業應用 90% 的 UI 需求，搭配 Angular CDK 能處理更復雜的互動場景。關鍵是建立一個共享的 `MaterialModule`，避免在各個 feature module 裡重複引入。
