...
tags:
  - Angular
readingTime: 1
description: "Angular 7 於 2018 年 10 月正式釋出，帶來了虛擬滾動、拖拽 CDK、效能最佳化等重要改進。本文梳理最值得關注的新特性。"
wordCount: 152
---

Angular 7 於 2018 年 10 月正式釋出，帶來了虛擬滾動、拖拽 CDK、效能最佳化等重要改進。本文梳理最值得關注的新特性。

## 虛擬滾動 Virtual Scrolling

`@angular/cdk/scrolling` 提供的虛擬滾動，僅渲染可見區域的列表項，大幅提升大列表效能：
