...
tags:
  ...
  - 工程化
readingTime: 1
description: "包體積是前端效能的重要指標。沒有限製的專案往往會漸漸膀起來——加個庫、唐唐就進得 100KB。效能預算的思路是：像財務預算一樣，把體積就是預算，超過就是超支。"
wordCount: 303
---

包體積是前端效能的重要指標。沒有限製的專案往往會漸漸膀起來——加個庫、唐唐就進得 100KB。效能預算的思路是：像財務預算一樣，把體積就是預算，超過就是超支。
