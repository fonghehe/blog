---
title: "React 表單受控與非控元件"
date: 2019-09-26 10:53:27
tags:
  - React
readingTime: 2
description: "React 表單受控與非控元件是日常開發中經常遇到的問題。本文從實際專案出發，分享具體的實現方法和經驗總結。"
---

React 表單受控與非控元件是日常開發中經常遇到的問題。本文從實際專案出發，分享具體的實現方法和經驗總結。
...
- React 表單受控與非控元件的關鍵在於理解核心概念，不要停留在表面用法
- 實際專案中根據場景選擇合適的方案
- 團隊中統一約定比追求完美實現更重要
