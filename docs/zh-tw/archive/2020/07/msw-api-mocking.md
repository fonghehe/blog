---
title: "MSW Mock Service Worker 介面模擬"
date: 2020-07-22 09:33:52
tags:
  - 測試
readingTime: 2
description: "在日常開發中，MSW Mock Service Worker 介面模擬的使用頻率越來越高。本文系統地講解其用法、原理和最佳化策略。"
wordCount: 300
---

在日常開發中，MSW Mock Service Worker 介面模擬的使用頻率越來越高。本文系統地講解其用法、原理和最佳化策略。
...
- MSW Mock Service Worker 介面模擬不是銀彈，需要根據專案規模和技術棧選擇
- 理解底層原理比記住 API 更重要
- 生產環境使用前務必做好相容性驗證
- 團隊協作中約定和文件比技術本身更重要
