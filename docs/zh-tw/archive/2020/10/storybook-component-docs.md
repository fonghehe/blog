---
title: "Storybook 元件文件與測試"
date: 2020-10-16 14:57:24
tags:
  - 測試
readingTime: 2
description: "最近在團隊中落地Storybook 元件文件與測試，積累了不少經驗。整理出來供參考，希望對做類似工作的同學有所幫助。"
wordCount: 324
---

最近在團隊中落地Storybook 元件文件與測試，積累了不少經驗。整理出來供參考，希望對做類似工作的同學有所幫助。
...
- 不要為了用新技術而用新技術
- 程式碼示例僅供參考，需根據業務場景調整
- Storybook 元件文件與測試不是銀彈，需要根據專案規模和技術棧選擇
