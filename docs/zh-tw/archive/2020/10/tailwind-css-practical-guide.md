...
tags:
  - CSS
readingTime: 2
description: "Tailwind CSS 這兩年越來越火，最近在一個內部工具專案中試用了一下。從\"這寫法太奇怪了\"到\"真香\"，記錄一下實際體驗。"
wordCount: 180
---

Tailwind CSS 這兩年越來越火，最近在一個內部工具專案中試用了一下。從"這寫法太奇怪了"到"真香"，記錄一下實際體驗。
...
<!-- 需要開啟 CSS 檔案看 card-title 具體是什麼 -->
<!-- .card-title { font-size: 18px; font-weight: 600; margin-bottom: 8px; } -->

<!-- Tailwind 寫法：樣式直接寫在 HTML 裡 -->
...
- 響應式設計用字首實現，比寫 media query 更直觀
- `@layer components` 提取可複用元件樣式，平衡原子和複用
- 生產環境務必開啟 PurgeCSS，否則體積巨大
- 適合內部工具和快速原型，品牌化專案需要設計系統配合
