...
Vuex 對 TypeScript 的支援一直不太好，建議手動定義型別：
...
坦白說，Pinia 的開發體驗更好。在 Vue 3 專案中如果還沒有技術包袱，建議直接用 Pinia：
...
- TypeScript 型別需要手動定義，這是 Vuex 的短板
- 如果是全新專案且沒有歷史包袱，建議評估 Pinia
- 模組化設計和名稱空間是大型專案的必備實踐