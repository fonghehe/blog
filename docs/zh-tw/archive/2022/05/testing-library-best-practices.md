---
title: "Testing Library 最佳實踐 2022"
date: 2022-05-23 09:48:09
tags:
  - 前端
readingTime: 2
description: "關於Testing Library 最佳實踐 2022，很多開發者隻停留在 API 呼叫層面。本文試圖從生產環境的角度，討論實際中會遇到的問題和解決方案。"
wordCount: 367
---

關於Testing Library 最佳實踐 2022，很多開發者隻停留在 API 呼叫層面。本文試圖從生產環境的角度，討論實際中會遇到的問題和解決方案。
...
- 不要為了用新技術而用新技術
- 程式碼示例僅供參考，需根據業務場景調整
- Testing Library 最佳實踐 2022不是銀彈，需要根據專案規模和技術棧選擇