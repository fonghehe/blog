...
tags:
  - 前端
readingTime: 2
description: "作為元件系統 owner，測試覆蓋率隻是起點。真正重要的是測試能攔住多少線上問題。分享一下我們元件庫的測試體系設計。"
wordCount: 317
---

作為元件系統 owner，測試覆蓋率隻是起點。真正重要的是測試能攔住多少線上問題。分享一下我們元件庫的測試體系設計。
...
E2E 隻覆蓋最核心的互動路徑，不要寫太多——維護成本高、速度慢。
