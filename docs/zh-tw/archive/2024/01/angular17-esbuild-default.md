...
tags:
  ...
  - Esbuild
readingTime: 2
description: "Angular 17 於 2023 年 11 月正式釋出，其中最直接影響開發體驗的改進之一是將 esbuild 設為預設構建器。新專案無需任何設定即可享受大幅加速的構建速度，老專案也隻需一個命令完成遷移。年初正好是盤點和升級的好時機，來看看這個改變究竟帶來了多大的實質提升。"
wordCount: 376
---

Angular 17 於 2023 年 11 月正式釋出，其中最直接影響開發體驗的改進之一是將 esbuild 設為預設構建器。新專案無需任何設定即可享受大幅加速的構建速度，老專案也隻需一個命令完成遷移。年初正好是盤點和升級的好時機，來看看這個改變究竟帶來了多大的實質提升。
...
# 修改 .html 範本 → ~150ms 內重新整理（Angular 17 開始支援範本 HMR）
