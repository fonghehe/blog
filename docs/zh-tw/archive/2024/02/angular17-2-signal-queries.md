...
tags:
  - Angular
readingTime: 2
description: "Angular 17.2 於 2024 年 2 月 14 日釋出，帶來了 Signal-based Queries 的開發者預覽。繼 Angular 17.1 引入 Signal Inputs（`input()` 函式）之後，17.2 將 Signal 化範圍擴充套件到了範本查詢：`viewChild()`、`view"
wordCount: 327
---
