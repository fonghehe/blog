...
Content Collections 讓你用型別安全的方式管理 Markdown/MDX 內容：
...
- Content Collections 提供型別安全的 Markdown/MDX 內容管理
- Schema 定義用 Zod，IDE 自動補全和型別檢查一應俱全
- 自動生成靜態路徑，配合 SSG 獲得最佳效能
- MDX 支援在文件中嵌入自定義元件
- 適合文件站、部落格、知識庫等以內容為主的專案
