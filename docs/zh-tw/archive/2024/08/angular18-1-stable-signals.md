...
```html
<app-select [(value)]="selectedUser" placeholder="選擇使用者">
...
Angular 18.1 是新 Signal API 從"可以嚐鮮"到"可以放心用於生產"的分水嶺。對於正在開發的新專案，現在是全面切換到 Signal API 的好時機；對於維護中的老專案，可以用官方 migration schematic 逐步遷移。Angular 朝著更簡潔、更型別安全、更高效能的方向走得更堅定了。
