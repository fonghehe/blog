...
tags:
  ...
  - 工程化
readingTime: 2
description: "Tailwind CSS v5 新特性這個話題社群討論了很多次，但隨著版本迭代，很多結論需要更新。本文基於最新版本重新梳理。"
---

Tailwind CSS v5 新特性這個話題社群討論了很多次，但隨著版本迭代，很多結論需要更新。本文基於最新版本重新梳理。
...
- 不要為了用新技術而用新技術
- 程式碼示例僅供參考，需根據業務場景調整
- Tailwind CSS v5 新特性不是銀彈，需要根據專案規模和技術棧選擇
